...
const uploadPost=async ()=>{
    ...
    try {
        ...
        const result=await axios.post(`${import.meta.env.serverUrl}/api/post/upload`,formData,{withCredentials:true})
...
const uploadStory=async ()=>{
    try {
        ...
        formData.append("mediaType",mediaType)
        formData.append("media",backendMedia)
        const result=await axios.post(`${import.meta.env.serverUrl}/api/story/upload`,formData,{withCredentials:true})
...
const uploadLoop=async ()=>{
    try {
        ...
        formData.append("caption",caption)
        formData.append("media",backendMedia)
        const result=await axios.post(`${import.meta.env.serverUrl}/api/loop/upload`,formData,{withCredentials:true})
